...
Let's visualize the problem for input array $\text{balls} = [2,1]$. Input array has $2$ balls of color 🔵, $1$ ball of color 🔴. The backtracking method starts with $\text{index} = 0$ and begins dividing the balls at that index into $2$ boxes.
...
```mermaid
graph TD
    A([Start]) --> |0 Blue Ball to Box1 <br /> 2 Blue Ball to Box2| B([Box2: 🔵 🔵])
    A --> |1 Blue Ball to Box1<br>1 Blue Ball to Box2| C([Box1: 🔵 <br /> Box2: 🔵])
    A --> |2 Blue Ball to Box1<br>0 Blue Ball to Box2| D([Box1: 🔵 🔵])

    B --> |0 Red Ball to Box1<br>1 Red Ball to Box2| E([Box2: 🔵 🔵 🔴])
    B --> |1 Red Ball to Box1<br>0 Red Ball to Box2| F([Box1: 🔴 <br /> Box2: 🔵 🔵])
    
    C --> |0 Red Ball to Box1<br>1 Red Ball to Box2| G([Box1: 🔵 <br /> Box2: 🔵 🔴])
    C --> |1 Red Ball to Box1<br>0 Red Ball to Box2| H([Box1: 🔵 🔴 <br /> Box2: 🔵])

    D --> |0 Red Ball to Box1<br>1 Red Ball to Box2| I([Box1: 🔵 🔵 <br /> Box2: 🔴])
    D --> |1 Red Ball to Box1<br>0 Red Ball to Box2| J([Box1: 🔵 🔵 🔴])
``` 
</div>
