...
This page provides links to solutions for problems that use the Greedy approach.
...
{[
	{ id: 2279, name: 'Maximum Bags With Full Capacity of Rocks' },
	{ id: 2323, name: 'Find Minimum Time to Finish All Jobs II' }
]}  
/>